...
RecTy *llvm_ks::resolveTypes(RecTy *T1, RecTy *T2) {
...
raw_ostream &llvm_ks::operator<<(raw_ostream &OS, const Record &R) {
...
raw_ostream &llvm_ks::operator<<(raw_ostream &OS, const RecordKeeper &RK) {
  OS << "------------- Classes -----------------\n";
...
Init *llvm_ks::QualifyName(Record &CurRec, MultiClass *CurMultiClass,
