...
SetTheory::SetTheory() {
  addOperator("add", llvm_ks::make_unique<AddOp>());
  addOperator("sub", llvm_ks::make_unique<SubOp>());
  addOperator("and", llvm_ks::make_unique<AndOp>());
  addOperator("shl", llvm_ks::make_unique<ShlOp>());
  addOperator("trunc", llvm_ks::make_unique<TruncOp>());
  addOperator("rotl", llvm_ks::make_unique<RotOp>(false));
  addOperator("rotr", llvm_ks::make_unique<RotOp>(true));
  addOperator("decimate", llvm_ks::make_unique<DecimateOp>());
  addOperator("interleave", llvm_ks::make_unique<InterleaveOp>());
  addOperator("sequence", llvm_ks::make_unique<SequenceOp>());
}
...
void SetTheory::addFieldExpander(StringRef ClassName, StringRef FieldName) {
  addExpander(ClassName, llvm_ks::make_unique<FieldExpander>(FieldName));
}
