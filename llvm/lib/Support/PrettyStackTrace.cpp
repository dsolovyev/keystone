...
static void PrintStack(raw_ostream &OS) {
  ...
  PrettyStackTraceEntry *ReversedStack =
      llvm_ks::ReverseStackTrace(PrettyStackTraceHead);
  ...
  llvm_ks::ReverseStackTrace(ReversedStack);
}
...
void llvm_ks::EnablePrettyStackTrace() {
#if defined(HAVE_BACKTRACE) && defined(ENABLE_BACKTRACES)
...
const void *llvm_ks::SavePrettyStackState() {
#if defined(HAVE_BACKTRACE) && defined(ENABLE_BACKTRACES)
...
void llvm_ks::RestorePrettyStackState(const void *Top) {
#if defined(HAVE_BACKTRACE) && defined(ENABLE_BACKTRACES)
