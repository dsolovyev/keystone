...
std::string PatternToMatch::getPredicateCheck() const {
  ...
  std::sort(PredList.begin(), PredList.end(), deref<llvm_ks::less>());
...
void CodeGenDAGPatterns::ParsePatternFragments(bool OutFrags) {
  ...
  for (Record *Frag : Fragments) {
    ...
    TreePattern *P =
        (PatternFragments[Frag] = llvm_ks::make_unique<TreePattern>(
...
static void CombineChildVariants(TreePatternNode *Orig,
  ...
  do {
    ...
    auto R = llvm_ks::make_unique<TreePatternNode>(
